...
IF EXIST "%SONAR_RUNNER_HOME%\lib\sonar-runner-dist-2.2.1.jar" goto run
...
%JAVA_EXEC% %SONAR_RUNNER_OPTS% -jar "%SONAR_RUNNER_HOME%\lib\sonar-runner-dist-2.2.1.jar" "-Drunner.home=%SONAR_RUNNER_HOME%" "-Dproject.home=%PROJECT_HOME%" %*
